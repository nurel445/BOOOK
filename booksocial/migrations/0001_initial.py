    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('list_type', models.CharField(choices=[('WT', 'Хочу прочитать'), ('IP', 'В процессе'), ('RD', 'Прочитано')], max_length=2, verbose_name='тип списка')),
                ('is_public', models.BooleanField(default=True, verbose_name='публичный список')),
                ('books', models.ManyToManyField(related_name='reading_lists', to='booksocial.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='booksocial.book')),
